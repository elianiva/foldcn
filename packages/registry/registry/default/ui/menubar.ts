...
// now use correct cn-menubar-* family (was cn-dropdown-menu-*). Items
// highlight via data-active (upstream focus:) per the derivation mapping; the
// panel's data-side is emitted from the anchor placement. Flat item
